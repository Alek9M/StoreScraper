...
import Store, { StoreConstructable, Tile } from "./stores/store.js";
...
export function currencyTextToNumber(text) {
  ...
  if (text?.trim() == "Multi Offers") return undefined;
...
export default class Scraper {
  ...
  browser;
  db: DB;
  constructor(browser: puppeteer.Browser, db: DB) {
  ...
  async basics(storeClass: StoreConstructable) {
  ...
  async scrape(storeClass: StoreConstructable) {
